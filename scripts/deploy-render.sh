...
git add .
git commit -m "Deploy: Backend com TypeScript corrigido $(date '+%Y-%m-%d %H:%M:%S')" || echo "Nenhuma mudança para commitar"
...
echo "   - TypeScript instalado como dependência do backend"
echo "   - package.json criado especificamente para o backend"
echo "   - rootDir configurado para src/backend/"
echo "   - Comandos de build simplificados"
echo ""
echo "⚠️  IMPORTANTE:"
